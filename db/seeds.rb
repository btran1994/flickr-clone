...
photo2.attach(io: file, filename: 'wallhaven-nr8y7q.jpg')
...
photo4.attach(io: file, filename: 'img06.jpg')
...
photo5.attach(io: file, filename: 'image19.png')
...
photo6.attach(io: file, filename: 'img12.jpg')
...
photo7.attach(io: file, filename: 'image14.jpg')
...
photo8.attach(io: file, filename: 'image15.jpg')
...
photo9.attach(io: file, filename: 'image18.jpg')
...
photo10.attach(io: file, filename: 'image16.jpg')
...
photo11.attach(io: file, filename: 'img08.jpg')
...
photo12.attach(io: file, filename: 'img09.png')
...
photo13.attach(io: file, filename: 'image17.jpg')
